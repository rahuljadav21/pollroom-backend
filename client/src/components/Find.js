...
function Find() {
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className="container validate-form" style={{display:'flex',flexDirection:'column',alignItems:'center'}} action="/pollroom/find" method="get">
